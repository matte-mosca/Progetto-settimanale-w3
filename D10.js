...
const whoIsBigger = function(num1, num2){
  if (num1 > num2) {
    ...
    console.log (num1 + " e " + num2 + " sono equivalenti ")
  }else {
...
const splitMe = function (string) {
 ...
 for ( i = 0; i < splitString.length; i++){
   splitString[i].charAt(0, 1).toUpperCase()
  }
...
const onlyLetters = function (string){
  ...
  for (i = 0; i < stringSplit.length ; i++){
    if( parseInt(stringSplit[i] === Number)){
...
isThisAnEmail("matttmosca@gmail.com")
/* ESERCIZIO 7
...
const howManyDays = function(day, month ,Year){
  ...
  return ("sono passati " +days+ " giorni " +months+ " mesi e " +years+ " anni."  )

}
howManyDays (6, 10, 1999)
/* ESERCIZIO 10
